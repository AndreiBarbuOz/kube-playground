...
**Note:** go-get or vendor this package as `github.com/AndreiBarbuOz/kube-playground`.
...
```sh
go get -d github.com/AndreiBarbuOz/kube-playground
cd $GOPATH/src/github.com/AndreiBarbuOz/kube-playground
godep restore
```
...
`kubernetes/staging/src/github.com/AndreiBarbuOz/kube-playground` and its dependencies
...
https://github.com/kubernetes/kubernetes/blob/master/staging/src/github.com/AndreiBarbuOz/kube-playground.
